...
ListView {
    ...
    header: Pane {
        ...
        RowLayout {
            ...
            Controls.SubtitleText {
                ...
                text: popupTitle > "" ? popupTitle.trim() : (typeof layerName !== "undefined" ? (layerName ? layerName : "") : "")
    ...
    delegate: ColumnLayout {
            ...
            Controls.SubtitleText {
                ...
                horizontalAlignment: Text.AlignLeft
                leftPadding: app.defaultMargin + app.units(5)
            }
            ...
            Rectangle {
                ...
                Image {
                    ...
                    MouseArea{
                        anchors.fill: parent
                        onClicked: {
                            if(typeof media[index].value.linkUrl!=="undefined" && media[index].value.linkUrl.toString()>"")
                                mapViewerCore.openUrlInternally(replaceVariables(decodeURIComponent(media[index].value.linkUrl), attributes));
                        }
                    }
                }
