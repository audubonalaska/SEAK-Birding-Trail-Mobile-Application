...
Rectangle{
    ...
    signal saveDataField(var editObject)
    Controls.Icon {
        id: editBtn
        imageWidth: app.units(16)
        imageHeight: app.units(16)
        anchors.right:parent.right
        visible:typeof canShowEditIcon !== "undefined"?canShowEditIcon:false
        anchors.verticalCenter: parent.verticalCenter
        //Material.elevation: 0
        maskColor: app.primaryColor//"#4c4c4c"
        //rotation: 180
        imageSource: "../../../MapViewer/images/pencil.png"
    ...
    Controls.Icon {
        id: nextEditField
        visible:typeof canShowDomainIcon !== "undefined"?canShowDomainIcon:false
        anchors.right:parent.right
        anchors.verticalCenter: parent.verticalCenter
    ...
    Controls.Icon {
        id: calendarIcon
        visible:typeof canShowCalendarIcon !== "undefined"  ? canShowCalendarIcon : false
        anchors.right:parent.right
        anchors.verticalCenter: parent.verticalCenter
    ...
    Component {
        ...
        Controls.CalendarDialog{
            ...
            x: !app.isRightToLeft ? (panelPage.width - width)/2 : (app.width - width - app.defaultMargin)
            y: app.isExpandButtonClicked ? (panelPage.height  - height)/2 : app.headerHeight + (panelPage.height  - height)/2
