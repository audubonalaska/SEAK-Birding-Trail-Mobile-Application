    ...
    */
        ...
        Column {
            ...
            Rectangle {
                ...
                ListView {
                    ...
                    model: controller.clientCertificateInfos//AuthenticationManager.clientCertificateInfos//authView.authenticationManager.clientCertificateInfos
            ...
            Row {
                ...
                Button {
                    ...
                    onClicked: {
                        ...
                        //if (challenge)
                            controller.continueWithClientCertificate(certificateList.currentIndex);
                        root.visible = false;
                    }
                }
            }
                ...
                Button {
                    ...
                    onClicked: {
                        ...
                        // attempt to add client certificate with the provided password
                         let isAdded = AuthenticationManager.addClientCertificate(certificatePasswordPage.certificateFile, passwordTextField.text);
    ...
    FileDialog {
        ...
        onAccepted: {
            ...
            let isAdded = controller.addClientCertificate(fileDialog.fileUrl, passwordTextField.text);
