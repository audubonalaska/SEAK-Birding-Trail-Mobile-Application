...
QtObject {
    ...
    */
    ...
    signal authenticationChallenge(var challenge)
    ...
    function getAuthenticatingHost()
    {
        return internal.currentChallenge.authenticatingHost
    }

    function getCurrentChallenge()
    {
        return internal.currentChallenge
    }
