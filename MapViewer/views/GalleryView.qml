        ...
        ColumnLayout {
            ...
            ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        Rectangle {
                            ...
                            Controls.BaseText {
                                ...
                                text: qsTr("%L1").arg(app.onlineMapPackages.count)
                                anchors.centerIn: parent
                            }
                ...
                Controls.MmpkManager {
                    ...
                    token: {
                        try {
                            return app.portal.credential ? app.portal.credential.token : ""
                        } catch (err) {
                            return ""
                        }
                    }
                ...
                function processSuccessfulDownload (index) {
                    console.log("processSuccessfulDownloadStart")
                    saveMapInfo(index)
                    galleryView.isDownloading = false
                    ...
                    console.log("processSuccessfulDownloadEnd")
                }
                    ...
                    RowLayout {
                        ...
                        Rectangle {
                            ...
                            Controls.BaseText {
                                ...
                                text: qsTr("%L1").arg(app.localMapPackages.count)
                                anchors.centerIn: parent
                            }
