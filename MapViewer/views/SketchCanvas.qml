...
import "../scripts/SketchLib.js" as SketchLib
...
Canvas {
    ...
    property bool canUndo:sketches.length > 0
    property bool canRedo:undoList.length > 0
    ...
    property var selectedArrowPenWidth:3
    property var selectedLinePenWidth:1
