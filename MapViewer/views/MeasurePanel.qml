...
Pane {
    ...
    RowLayout {
        ...
        Controls.ComboBox {
            ...
            function updateDistance (realValue) {
                ...
                measurementUnit.model.append({itemLabel: distanceUnits.kMeters.arg(realValue<1000000? parseFloat(realValue.toFixed(0)).toLocaleString(Qt.locale()):parseFloat(realValue.toExponential(3)).toLocaleString(Qt.locale())), unit: lengthUnits.meters})
                measurementUnit.model.append({itemLabel: distanceUnits.kMiles.arg((realValue*0.000621371)<1000000?parseFloat((realValue*0.000621371).toFixed(2)).toLocaleString(Qt.locale()): parseFloat((realValue*0.000621371).toExponential(3)).toLocaleString(Qt.locale())), unit: lengthUnits.miles})
                measurementUnit.model.append({itemLabel: distanceUnits.kKilometers.arg((realValue*0.001)<10000000? parseFloat((realValue*0.001).toFixed(2)).toLocaleString(Qt.locale()):parseFloat((realValue*0.001).toExponential(3)).toLocaleString(Qt.locale())), unit: lengthUnits.kilometers})
                measurementUnit.model.append({itemLabel: distanceUnits.kFeet.arg((realValue*3.28084)<1000000?parseFloat((realValue*3.28084).toFixed(0)).toLocaleString(Qt.locale()):parseFloat((realValue*3.28084).toExponential(3)).toLocaleString(Qt.locale())), unit: lengthUnits.feet})
                measurementUnit.model.append({itemLabel: distanceUnits.kFeetUS.arg((realValue*3.28083)<1000000?parseFloat((realValue*3.28083).toFixed(0)).toLocaleString(Qt.locale()):parseFloat((realValue*3.28083).toExponential(3)).toLocaleString(Qt.locale())), unit: lengthUnits.feetUS})
                measurementUnit.model.append({itemLabel: distanceUnits.kYards.arg((realValue*1.09361)<1000000?parseFloat((realValue*1.09361).toFixed(1)).toLocaleString(Qt.locale()):parseFloat((realValue*1.09361).toExponential(3)).toLocaleString(Qt.locale())), unit: lengthUnits.yards})
                measurementUnit.model.append({itemLabel: distanceUnits.kNauticalMiles.arg((realValue*0.000539957)<1000000?parseFloat((realValue*0.000539957).toFixed(1)).toLocaleString(Qt.locale()):parseFloat((realValue*0.000539957).toExponential(3)).toLocaleString(Qt.locale())), unit: lengthUnits.nauticalMiles})
            ...
            function updateArea (realValue) {
                ...
                var index = measurementUnit.listView.currentIndex
                measurementUnit.model.clear()
                measurementUnit.model.append({itemLabel: areaUnits.kSqMeters.arg(realValue<1000000?parseFloat(realValue.toFixed(0)).toLocaleString(Qt.locale()):parseFloat(realValue.toExponential(3)).toLocaleString(Qt.locale()))})
                measurementUnit.model.append({itemLabel: areaUnits.kAcres.arg((realValue/4046.86)<1000000?parseFloat((realValue/4046.86).toFixed(1)).toLocaleString(Qt.locale()):parseFloat((realValue/4046.86).toExponential(3)).toLocaleString(Qt.locale()))})
                measurementUnit.model.append({itemLabel: areaUnits.kSqMiles.arg((realValue/2589990)<1000000?parseFloat((realValue/2589990).toFixed(2)).toLocaleString(Qt.locale()):parseFloat((realValue/2589990).toExponential(3)).toLocaleString(Qt.locale()))})
                measurementUnit.model.append({itemLabel: areaUnits.kSqKilometers.arg((realValue/1000000)<1000000?parseFloat((realValue/1000000).toFixed(2)).toLocaleString(Qt.locale()):parseFloat((realValue/1000000).toExponential(3)).toLocaleString(Qt.locale()))})
                measurementUnit.model.append({itemLabel: areaUnits.kHectares.arg((realValue/10000)<1000000?parseFloat((realValue/10000).toFixed(1)).toLocaleString(Qt.locale()):parseFloat((realValue/10000).toExponential(3)).toLocaleString(Qt.locale()))})
                measurementUnit.model.append({itemLabel: areaUnits.kSqYards.arg((realValue/0.836128)<1000000?parseFloat((realValue/0.836128).toFixed(1)).toLocaleString(Qt.locale()):parseFloat((realValue/0.836128).toExponential(3)).toLocaleString(Qt.locale()))})
                measurementUnit.model.append({itemLabel: areaUnits.kSqFeet.arg((realValue/0.092903)<1000000?parseFloat((realValue/0.092903).toFixed(1)).toLocaleString(Qt.locale()):parseFloat((realValue/0.092903).toExponential(3)).toLocaleString(Qt.locale()))})
                measurementUnit.model.append({itemLabel: areaUnits.kSqFeetUS.arg((realValue*10.7638)<1000000?parseFloat((realValue*10.7638).toFixed(1)).toLocaleString(Qt.locale()):parseFloat((realValue*10.7638).toExponential(3)).toLocaleString(Qt.locale()))})
                measurementUnit.listView.currentIndex = index < 0 ? 0 : index
                measurementUnit.updateLabel()
            }
        }
        ...
        Menu {
            ...
            x: app.isLeftToRight ? (parent.width-settingsContent.width-2*defaultMargin) : 2*defaultMargin
            y : -app.units(150)
            padding: 0
    ...
    function convert (realValue, toUnit) {
        ...
        case lengthUnits.meters:
            ...
            return realValue<1000000? parseFloat(realValue.toFixed(0)).toLocaleString(Qt.locale()):parseFloat(realValue.toExponential(3)).toLocaleString(Qt.locale())
        case lengthUnits.miles:
            return (realValue*0.000621371)<1000000?parseFloat((realValue*0.000621371).toFixed(2)).toLocaleString(Qt.locale()): parseFloat((realValue*0.000621371).toExponential(3)).toLocaleString(Qt.locale())
        case lengthUnits.kilometers:
            return (realValue*0.001)<10000000? parseFloat((realValue*0.001).toFixed(2)).toLocaleString(Qt.locale()):parseFloat((realValue*0.001).toExponential(3)).toLocaleString(Qt.locale())
        case lengthUnits.feet:
            return (realValue*3.28084)<1000000?parseFloat((realValue*3.28084).toFixed(0)).toLocaleString(Qt.locale()):parseFloat((realValue*3.28084).toExponential(3)).toLocaleString(Qt.locale())
        case lengthUnits.feetUS:
            return (realValue*3.28083)<1000000?parseFloat((realValue*3.28083).toFixed(0)).toLocaleString(Qt.locale()):parseFloat((realValue*3.28083).toExponential(3)).toLocaleString(Qt.locale())
        case lengthUnits.yards:
            return (realValue*1.09361)<1000000?parseFloat((realValue*1.09361).toFixed(1)).toLocaleString(Qt.locale()):parseFloat((realValue*1.09361).toExponential(3)).toLocaleString(Qt.locale())
        case lengthUnits.nauticalMiles:
            return (realValue*0.000539957)<1000000?parseFloat((realValue*0.000539957).toFixed(1)).toLocaleString(Qt.locale()):parseFloat((realValue*0.000539957).toExponential(3)).toLocaleString(Qt.locale())
        default:
            return realValue
        }
    }
